...
<body class="fix-header fix-sidebar card-no-border">
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
                                                <p class="text-muted"><a href="https://www.wrappixel.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a9dfc8dbdcc7e9cec4c8c0c587cac6c4">[email&#160;protected]</a></p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
    ...
    <!-- Chart JS -->
    <script src="minimal/js/dashboard1.js"></script>
    <script src="minimal/js/toastr.js"></script>
    <script>
    $.toast({
