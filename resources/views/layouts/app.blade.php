...
<!-- Mirrored from www.wrappixel.com/demos/admin-templates/monster-admin/minimal/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Jan 2020 07:19:28 GMT -->
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
        <div class="page-wrapper" style="@guest margin-left:0px @endguest">
            <!-- ============================================================== -->
            <!-- Container fluid  -->
            <!-- ============================================================== -->
            @yield('content')
...
<!-- Mirrored from www.wrappixel.com/demos/admin-templates/monster-admin/minimal/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Jan 2020 07:19:29 GMT -->
