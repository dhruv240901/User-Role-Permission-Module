...
<section id="wrapper">
        <div class="login-register" style="background-image:url(assets/images/background/login-register.jpg);">
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{ route('custom-login') }}" id="loginform" method="POST">
                    @csrf
                    ...
                    <div class="form-group mb-0">
                        <div class="col-sm-12 text-center">
                            <p>Don't have an account? <a href="{{ route('signup') }}" class="text-info ml-1"><b>Sign Up</b></a></p>
                        </div>
                    </div>
                </form>
            </div>
